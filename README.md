...
6. Monitoring script tftp-monitor.sh placed on your host machine.


### Monitoring script in-depth:
...
**Monitoring script source:**

<details>
	<summary>tftp-monitor.sh</summary>
...
<details>
	<summary>tftp-monitor.yaml</summary>
